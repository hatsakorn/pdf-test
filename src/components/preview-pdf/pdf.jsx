...
Font.registerHyphenationCallback((word) => {
  ...
  // การตัดคำตามความยาวที่กำหนด
  for (let i = 0; i < word.length; i += maxLength) {
    const part = word.substring(i, maxLength + i);
    // เพิ่ม hyphen ถ้าคำถูกตัด
...
//   const parts =
//     word.length === 1 ? [word] : [word.substring(0, middle), word.substring(middle)];
  ...
  return (
    <Document>
      <Page size="A4" style={{ ...styles.page }}>
        <View style={{ display: "flex", flexDirection: "row", width: 390 }}>
